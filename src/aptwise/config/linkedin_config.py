...
print(f"🔍 Loading LinkedIn OAuth config...")
print(f"CLIENT_ID: {os.getenv('LINKEDIN_CLIENT_ID')}")
print(f"CLIENT_SECRET: {'*' * len(os.getenv('LINKEDIN_CLIENT_SECRET', '')) if os.getenv('LINKEDIN_CLIENT_SECRET') else 'None'}")
...
LINKEDIN_EMAIL_URL = "https://api.linkedin.com/v2/emailAddresses?q=members&projection=(elements*(handle~))"
